        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <?php echo form_open_multipart('Announcement/updateAnnouncement/' . $data->id)?>
              ...
              <div class="form-group mb-5">
                <label for="author"><span style="color: red; margin-right: 3px">*</span>Author</label>
                <input type="text" class="form-control" name="author" id="author" placeholder="Author" value="<?= $data->author ?>" required>
              </div>
              <div class="form-group mb-5">
                <label for="receiver"><span style="color: red; margin-right: 3px">*</span>Receiver</label>
                <input type="text" class="form-control" name="receiver" id="receiver" placeholder="Receiver" value="<?= $data->receiver ?>" required>
              </div>
              <div class="form-group mb-5">
