        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <a data-toggle="modal" data-target="#modal-success" class="btn btn-success btn-sm" style="width: 120px; margin-left: 10px">
                    <i class="fa fa-fw fa-plus"></i>Add Technology
                </a>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $i = 1; foreach ($technology as $data): ?>
                            <tr>
                                <td><?= $i++; ?></td>
                                <td><?= $data->label ?></td>
                                <td style="text-align: center;">
                                    ...
                                    <a href="<?= base_url('Product/DeleteTechnology/'.$data->id) ?>" onclick="return confirm('Are you sure you want to delete this item?');">
                ...
                <div class="modal modal-success fade" id="modal-success">
                    <?= form_open_multipart('Product/AddTechnology/') ?>
                ...
                <div class="modal modal-info fade" id="modal-edit">
                    <?= form_open_multipart('Product/EditTechnology/') ?>
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
